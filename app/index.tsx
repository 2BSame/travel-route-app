...
const busSchedules: BusSchedule[] = [
  {
    fromBusStopId: SCHOOL_STOP_ID,
    toBusStopId: 1,
    busNumber: "110",
    estimatedMinutes: 18,
    departureTimes: outboundDepartures,
  },
  {
    fromBusStopId: SCHOOL_STOP_ID,
    toBusStopId: 2,
    busNumber: "210",
    estimatedMinutes: 23,
    departureTimes: outboundDeparturesOffset,
  },
  {
    fromBusStopId: SCHOOL_STOP_ID,
    toBusStopId: 3,
  ...
  {
    fromBusStopId: 1,
    toBusStopId: SCHOOL_STOP_ID,
    busNumber: "110",
    estimatedMinutes: 18,
    departureTimes: returnDepartures,
  },
  {
    fromBusStopId: 2,
    toBusStopId: SCHOOL_STOP_ID,
    busNumber: "210",
    estimatedMinutes: 23,
    departureTimes: returnDeparturesOffset,
  },
  {
    fromBusStopId: 3,
    toBusStopId: SCHOOL_STOP_ID,
...
const PLACES_DATA: Place[] = [
  {
    ...
    y: 43,
    category: "카페",
    categoryBit: categoryMask.CAFE,
    themeBit: themeMask.EMOTION | themeMask.QUIET,
    duration: 30,
    type: "normal",
    description:
      "상가거리 초입에 가까워 옥동 루트의 시작 지점으로 쓰기 좋습니다.",
    nearestBusStopId: 3,
  },
  {
    id: 2,
    ...
    category: "카페",
    categoryBit: categoryMask.CAFE,
    themeBit: themeMask.QUIET,
    duration: 25,
    type: "normal",
    description: "가볍게 음료를 마시며 다음 장소로 이동하기 좋은 카페입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 3,
    ...
    category: "카페",
    categoryBit: categoryMask.CAFE,
    themeBit: themeMask.EMOTION,
    duration: 40,
    type: "normal",
    description: "지도 북서쪽 상권에 위치한 여유로운 디저트 카페입니다.",
    nearestBusStopId: 3,
  },
  {
    id: 4,
    ...
    duration: 20,
    type: "normal",
    description: "짧은 동선 중간에 넣기 좋은 가성비 카페입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 5,
    ...
    y: 56,
    category: "디저트",
    categoryBit: categoryMask.DESSERT,
    themeBit: themeMask.FOOD | themeMask.EMOTION,
    duration: 45,
    type: "normal",
    description:
      "디저트 중심 루트에서 체류 시간을 충분히 줄 수 있는 장소입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 6,
    ...
    y: 48,
    category: "먹거리",
    categoryBit: categoryMask.FOOD,
    themeBit: themeMask.FOOD,
    duration: 30,
    type: "normal",
    description: "상가거리 중심부의 분식 장소로 먹거리 루트와 잘 맞습니다.",
    nearestBusStopId: 1,
  },
  {
    id: 7,
    ...
    duration: 60,
    type: "normal",
    description: "식사 시간이 긴 루트에서 메인 식사 장소로 활용할 수 있습니다.",
    nearestBusStopId: 1,
  },
  {
    id: 8,
    ...
    type: "normal",
    description:
      "상권 동쪽에 위치한 식사 장소로 루트 후반에 배치하기 좋습니다.",
    nearestBusStopId: 1,
  },
  {
    id: 9,
    ...
    duration: 30,
    type: "normal",
    description: "짧은 식사 시간으로도 일정에 넣기 쉬운 패스트푸드 지점입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 10,
    ...
    duration: 25,
    type: "normal",
    description: "중앙 도보 동선과 가까워 빠르게 식사하기 좋은 장소입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 11,
    ...
    y: 58,
    category: "쇼핑",
    categoryBit: categoryMask.SHOPPING,
    themeBit: themeMask.CULTURE,
    duration: 20,
    type: "normal",
    description: "쇼핑과 구경 요소를 넣고 싶을 때 적합한 지점입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 12,
    ...
    duration: 35,
    type: "normal",
    description: "생활용품 구경과 쇼핑 시간을 반영하기 좋은 장소입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 13,
    ...
    y: 47,
    category: "문화/상권",
    categoryBit: categoryMask.CULTURE,
    themeBit: themeMask.CULTURE | themeMask.FOOD,
    duration: 50,
    type: "active",
    description:
      "옥동 상권의 중심 동선으로 먹거리와 구경 요소를 함께 제공합니다.",
    nearestBusStopId: 1,
  },
  {
    id: 14,
    ...
    y: 22,
    category: "자연",
    categoryBit: categoryMask.NATURE,
    themeBit: themeMask.NATURE | themeMask.QUIET,
    duration: 30,
    type: "normal",
    description: "상권 위쪽의 녹지 구역으로 조용한 산책 테마와 어울립니다.",
    nearestBusStopId: 3,
  },
  {
    id: 15,
    ...
    category: "문화/상권",
    categoryBit: categoryMask.CULTURE,
    themeBit: themeMask.CULTURE | themeMask.QUIET,
    duration: 40,
    type: "normal",
    description: "조용한 문화 루트에서 휴식형 장소로 배치할 수 있습니다.",
    nearestBusStopId: 2,
  },
  {
    id: 16,
    ...
    y: 42,
    category: "편의점",
    categoryBit: categoryMask.CONVENIENCE,
    themeBit: themeMask.QUIET,
    duration: 15,
    type: "normal",
    description: "동선 초반 간식이나 음료를 보충하기 좋은 편의점입니다.",
    nearestBusStopId: 3,
  },
  {
    id: 17,
    ...
    duration: 10,
    type: "normal",
    description: "서쪽 골목 동선에 배치하기 좋은 짧은 체류 장소입니다.",
    nearestBusStopId: 3,
  },
  {
    id: 18,
    ...
    y: 45,
    category: "베이커리",
    categoryBit: categoryMask.BAKERY,
    themeBit: themeMask.FOOD,
    duration: 25,
    type: "normal",
    description: "간식 루트에서 자연스럽게 연결되는 베이커리 장소입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 19,
    ...
    duration: 20,
    type: "normal",
    description: "루트 후반에 짧게 들르기 좋은 디저트 지점입니다.",
    nearestBusStopId: 2,
  },
  {
    id: 20,
    ...
    duration: 45,
    type: "normal",
    description: "동남쪽 구역의 여유로운 카페 체류 장소입니다.",
    nearestBusStopId: 2,
  },
  {
    id: 21,
    ...
    duration: 120,
    type: "target",
    description: "문화 테마의 긴 체류 목적지로 사용할 수 있는 장소입니다.",
    nearestBusStopId: 2,
  },
  {
    id: 22,
    ...
    duration: 40,
    type: "normal",
    description: "서쪽 골목 상권의 식사 후보로 먹거리 테마와 잘 맞습니다.",
    nearestBusStopId: 3,
  },
  {
    id: 23,
    ...
    y: 49,
    category: "감성",
    categoryBit: categoryMask.EMOTION,
    themeBit: themeMask.EMOTION,
    duration: 90,
    type: "normal",
    description: "감성 분위기 테마에서 루트의 개성을 만들어 주는 장소입니다.",
    nearestBusStopId: 1,
  },
  {
    id: 24,
    ...
    y: 63,
    category: "스포츠",
    categoryBit: categoryMask.SPORT,
    themeBit: themeMask.CULTURE,
    duration: 60,
    type: "normal",
    description: "활동형 루트에 넣을 수 있는 스포츠 지점입니다.",
    nearestBusStopId: 3,
  },
  {
    id: 25,
    ...
    duration: 40,
    type: "normal",
    description: "복주초 인근의 작은 골목 상권을 둘러보는 장소입니다.",
    nearestBusStopId: 2,
  },
];
...
function getBusStopName(stopId: number): string {
  ...
  return (
    OKDONG_BUS_STOPS.find((stop) => stop.id === stopId)?.name ||
    `정류장 ${stopId}`
  );
}

function findNextDirectBus(
  fromStopId: number,
  toStopId: number,
  currentTime: string,
): NextBusInfo | null {
  ...
  const schedules = busSchedules.filter(
    (s) => s.fromBusStopId === fromStopId && s.toBusStopId === toStopId,
  );
...
function filterPlacePool(userTheme: string, mealOption: string): Place[] {
  return PLACES_DATA.filter((place) => {
    if (mealOption === "카페만")
      return ["카페", "디저트", "베이커리"].includes(place.category);
    if (mealOption === "관광지만")
      return ["자연", "문화", "쇼핑", "문화/상권", "스포츠", "감성"].includes(
        place.category,
      );
    return true;
  }).sort((a, b) => {
...
function buildOkdongRoute(
  userTheme: string,
  mealOption: string,
  maxOkdongMinutes: number,
) {
  ...
  while (route.length < 8) {
    ...
    for (const place of pool) {
      ...
      if (mealOption === "식사 포함" && place.category === "먹거리")
        score += 45;
  ...
  const endStop =
    route.length > 0 ? getNearestBusStop(route[route.length - 1]) : startStop;
  const returnWalkMinutes =
    route.length > 0 ? getWalkMinutes(route[route.length - 1], endStop) : 0;
...
function buildGeneratedPlan(
  ...
  const coreRoute = buildOkdongRoute(
    userTheme,
    mealOption,
    selectedOkdongMinutes,
  );
  const outboundBus = findNextDirectBus(
    SCHOOL_STOP_ID,
    coreRoute.startStop.id,
    selectedStartTime,
  );
  ...
  const returnBus = findNextDirectBus(
    coreRoute.endStop.id,
    SCHOOL_STOP_ID,
    okdongEndTime,
  );
  const actualEndTime = returnBus?.arrivalTime || okdongEndTime;

  const outboundExtra = outboundBus
    ? outboundBus.waitTime + outboundBus.rideTime
    : 0;
  ...
  const endPoint =
    coreRoute.endStop.id === coreRoute.startStop.id
      ? {
          ...coreRoute.endStop,
          x: Math.min(coreRoute.endStop.x + 3, 96),
          y: Math.min(coreRoute.endStop.y + 3, 96),
        }
      : coreRoute.endStop;

  const routeMapPoints: RouteMapPoint[] = [
    {
      key: `bus-start-${coreRoute.startStop.id}`,
      name: coreRoute.startStop.name,
      x: coreRoute.startStop.x,
      y: coreRoute.startStop.y,
      kind: "bus",
    },
    ...
    {
      key: `bus-end-${coreRoute.endStop.id}`,
      name: coreRoute.endStop.name,
      x: endPoint.x,
      y: endPoint.y,
      kind: "bus",
    },
